...
-----
# Advertise 광고 컨트렉트 구현 성공
  블록체인의 저장할 광고등록 데이터 스마트 컨트렉트 작성 
구현 목표

1.누구나 광고를 등록할 수 있어여 한다.(완료)

2.캠페인에는 목표 좋아요와 
종료 기간이 있어야한다.(완료)

3.등록된 캠페인 기록은 지워지지 않는다.(완료)

4.좋아요를 해준 사람에 대한 기록을 남겨야한다. (완료)

5.목표 좋아요를 달성했다면 좋아요를 
해준사람에게 같은양의 리워드를 지급해야한다.(완료)

6.목표 좋아요를 달성하지 못했다면 
리워드 금액은 환불해야 한다(보류)

광고등록 스마트 컨트랙트 포지티브,네거티브테스트.(진행중)
